  ...
  return (
    <div className="flex flex-col lg:flex-row bg-[#06110D] min-h-screen justify-center gap-4 pt-16">
      ...
      <div className="w-full lg:w-1/4 flex flex-col max-h-fit gap-4 text-sm text-black bg-[#0f2d1f] rounded-lg mb-4 p-4">
        ...
        {zikrList.map((zikr) => (
          <button
            ...
            className={`w-full mb-2 p-3 block border-black rounded-md px-4 py-2  ${
              zikr === selectedbtn
      ...
      <div className="w-full lg:w-1/3 flex flex-col gap-4 text-sm">
        ...
        items-center flex-col md:w-full">
          {/* today count  */}
          <div className="flex items-center bg-[rgb(3,52,75)] gap-4 w-[50%]">
            <p className="flex-1 text-xl text-yellow-500 font-normal p-4 gap-4"> 
              Today's count
            </p>
            <p className="flex-1 text-3xl text-yellow-500 font-bold p-2 gap-2">
              347
            </p>
          </div>

          {/* streak*/}
          <div className="flex bg-[rgb(3,52,75)]  gap-4 w-1/2">
            <p className="flex-1 text-xl text-orange-500 font-normal p-4 gap-4">
              🔥Streak
            </p>
            <p className="flex-1 text-3xl text-orange-500 font-bold p-4 gap-4">
              12
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 w-full text-sm">
          ...
          <div className="flex bg-[rgb(3,52,75)] rounded-lg gap-4 p-4 text-red-500">
            <p cclassName="flex-1 text-x font-normal  mb-3 p-4 gap-4">
              Daily Target
            </p>
        ...
        <div className="bg-[rgb(3,52,75)]  rounded-lg p-4">
          <p className="text-xl text-orange-300 mb-2">Daily motivation</p>
        ...
        {/* Analyse Button */}
        <button className="w-full bg-[rgb(2,105,31)] text-white py-2 rounded-lg border border-gray-700 hover:bg-green-600 transition">
          Analyse →
        </button>
      </div>
      ...
      <div className="w-full lg:w-[20%] flex flex-col gap-4 text-sm text-white">
        ...
        <div className="bg-[#0f2d1f] rounded-lg p-4">
          <p className="text-2xl text-purple-400 mb-3">Global standing</p>
          {[
          ...
          <div className="flex justify-between text-sm text-[rgb(12,227,255)] py-2 bg-green-900 rounded px-2 mt-2">
            <span>#47</span>
            <span>You</span>
            <span>0</span>
          </div>
        ...
        {/* Country Standing */}
        <div className="bg-[#0f2d1f] rounded-lg p-4">
          <p className="text-2xl text-purple-400 mb-3">Country standing 🇧🇩</p>
          {[
